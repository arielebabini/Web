...
-- Messaggi di conferma utilizzando SELECT invece di DO
SELECT 'Database CoWorkSpace inizializzato con dati di esempio!' AS init_message;
SELECT 'Utenti creati: admin@coworkspace.com, manager.milano@coworkspace.com, manager.roma@coworkspace.com, manager.torino@coworkspace.com, client1@example.com, client2@example.com, client3@example.com' AS users_created;
SELECT 'Password per tutti gli utenti: admin123' AS default_password;
SELECT 'Spazi creati: 6' AS spaces_count;
SELECT 'Prenotazioni di esempio: 3' AS bookings_count;
SELECT 'Recensioni di esempio: 2' AS reviews_count;